      ...
      <div className="relative w-screen h-screen  mt-4  ">
        ...
        <div className="absolute inset-0 mt-36 sm:mt-28  w-3/4 mx-auto backdrop-opacity-80">
          ...
          <p className="sm:text-justify sm:w-56 mx-auto sm:text-base text-center font-medium sm:mt-7 mt-14 text-2xl">
            ...
            something amazing. Our platform is a nurturing ground for bloggers,
            thinkers, and storytellers to cultivate their passions and share
            them with the world. Whether you're a seasoned writer or just
            starting your blogging journey, Glog is here to provide you with a
            platform to showcase your creativity, insights, and expertise.
          </p>
